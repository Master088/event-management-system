import {  ADD_EVENT_MUTATION, DELETE_EVENT, DELETE_REGISTRATION, SET_DASHBOARD_EVENTS, SET_DELETE_EVENT, SET_DELETE_REGISTRATION, SET_EDIT_EVENT, SET_EVENT, SET_EVENTS, SET_EVENT_REGISTRATIONS, SET_EVENT_REGISTRATION_STATUS, SET_REGISTER, SET_UNREGISTERED_STUDENT, SET_USER_EVENT_HISTORY } from "../../store-constants";
...
export default {
  ...
  [SET_USER_EVENT_HISTORY](state, payload) {
    state.event_history = payload;
  },
};
