<template>
  <div>
    ...
    <div class="container pt-5 ">
      <!-- joined event card -->
      <div class="row row-cols-1 row-cols-md-3" v-if="active == 'joined'">
        <div class="col mb-4" v-for="event in joined_event" :key="event.id">
      ...
      <!-- today event card -->
      <div class="row row-cols-1 row-cols-md-3" v-if="active == 'today'">
          <div class="col mb-4" v-for="event in event_today" :key="event.id">
            <div class="card h-100">
              <div class="card-header bg-transparent">
                  <div class="row">
                    <span><p class="d-flex justify-content-end date-t">Date: <b>{{ event.date }}</b></p></span>
      ...
      <!-- upcoming event card -->
      <div class="row row-cols-1 row-cols-md-3" v-if="active == 'upcoming'">
          <div class="col mb-4" v-for="event in upcoming" :key="event.id">
            <div class="card h-100">
              <div class="card-header bg-transparent">
                  <div class="row">
                    <span><p class="d-flex justify-content-end date-t">Date: <b>{{ event.date }}</b></p></span>
