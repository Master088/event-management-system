        ...
        <div class="fluid-container" style="padding: 5% 20% 10px">
            ...
            >
                ...
                <div class="card-body-container" style="width: 90%; margin: 5%">
                    ...
                    <p>
                        A request to reset password was received from TNHS Event Management System   associated with your
                        <span style="color: #2b99be; text-decoration: none;"><b> {{$email}}</b></span> account.
                    </p>
                    <h3>Token:{{$token}}</h3>
